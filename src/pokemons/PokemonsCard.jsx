...
const PokemonsCard = ({ pokemon }) => {
    ...
    return (
        ...
        <div className="flex flex-col gap-1">
            <p className="text-zinc-400 text-sm text-center font-thin">Hp: {hp}</p>
            <h5 className="text-white text-xl text-center font-medium">{name}</h5>
            <p className="text-zinc-400 text-sm text-center font-extralight">{type}</p>
        </div>
